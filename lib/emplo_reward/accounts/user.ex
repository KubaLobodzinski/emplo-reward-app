defmodule EmploReward.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, EmploReward.Repo)
  ...
  """
  def valid_password?(%EmploReward.Accounts.User{hashed_password: hashed_password}, password)
